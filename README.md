# Snakemake workflow: `wgs-mosdepth-maftools-copy-numbers`
...
[![workflow catalog](https://img.shields.io/badge/Snakemake%20workflow%20catalog-darkgreen)](https://snakemake.github.io/snakemake-workflow-catalog/docs/workflows/dlaehnemann/wgs-mosdepth-maftools-copy-numbers)

A Snakemake workflow for determining segmental copy numbers from mapped whole genome sequencing data (SAM/BAM/CRAM) using mosdepth and maftools. 

- [Snakemake workflow: `wgs-mosdepth-maftools-copy-numbers`](#snakemake-workflow-name)
  - [Usage](#usage)
...
The usage of this workflow is described in the [Snakemake Workflow Catalog](https://snakemake.github.io/snakemake-workflow-catalog/docs/workflows/dlaehnemann/wgs-mosdepth-maftools-copy-numbers).
